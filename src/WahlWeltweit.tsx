...
const WahlWeltweit = () => {
    ...
    return (
        <><div className="red_block ">
            <a className="gap-3 valign-middle justify-center" href="https://gruene-weltweit.de/SitePages/Bundestagswahl2021.aspx">OV Washington - Briefwahl Suchmaschine
        ...
        <div className="container topmargin-sm bottommargin-sm clearfix">
            <section className="bg-red">
                ...
                <h3 className='m-0'><a className="m-0 gap-2 valign-middle " href="https://gruene-weltweit.de/SitePages/BriefwahlSearch.aspx">OV Washington
                            ...
                            <div className="key-documents__item swiper-slide">
                                ...
                                <div className="key-documents__content">
                                    <img title="Infos Bundeswahlleiter Auslandsdeutsche 2021"
                                        src="https://gruene-weltweit.de/Site%20Collection%20Images/ICONS/icgen.gif?rev=23"/>
